            ...
            {props.characters.map((character) =>
                <Card style={{margin: '10px'}}>
                    <CardBody style={{borderStyle: 'solid', padding: '5px'}}>
                        ...
                        <CardText style={{textAlign: 'justify'}}>Lucas ipsum dolor sit amet kohl frozarns joruus vel ord
                            antonio himoran olié darpa noa. Aqualish cordé givin ansion. Verpine irek shistavanen
                            carondian mustafar antilles castell porkins besalisk. Falleen utapaun isolder joh balosar
                            bail farlander tagge. Thrackan fel annoo biggs. Zekk huk moore bothawui ansuroer owen.
                            Snivvian zeltron b4-d4 gand coruscant ventress organa chazrach pa'lowick. Mirta ponda kuat
                            muunilinst spar klivian. Davin devaronian zabrak jabiimas sebulba grievous saurin. Gordin
